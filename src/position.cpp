...
void Position::init() {
  ...
  Zobrist::noPawns = Key::rand(&rng1,&rng2);
}
...
void Position::set_state(StateInfo* si) const {
  ...
  for (Bitboard b = pieces(); b; )
  {
      Square s = pop_lsb(&b);
      Piece pc = piece_on(s);
      si->key.xor_in(Zobrist::psq[pc][s]);
  ...
  {
      Square s = pop_lsb(&b);
      si->pawnKey.xor_in(Zobrist::psq[piece_on(s)][s]);
  }
  ...
  for (Piece pc : Pieces)
  {
      ...
      for (int cnt = 0; cnt < pieceCount[pc]; ++cnt)
          si->materialKey.xor_in(Zobrist::psq[pc][cnt]);
  }
}
...
void Position::do_move(Move m, StateInfo& newSt, bool givesCheck) {
  ...
  if (type_of(m) == CASTLING)
  {
      ...
      k.xor_in(Zobrist::psq[captured][rfrom] ^ Zobrist::psq[captured][rto]);
      captured = NO_PIECE;
  }
  ...
  if (captured)
  {
      ...
      if (type_of(captured) == PAWN)
      {
          ...
          st->pawnKey.xor_in(Zobrist::psq[captured][capsq]);
      }
      else
      ...
      k.xor_in(Zobrist::psq[captured][capsq]);
      st->materialKey.xor_in(Zobrist::psq[captured][pieceCount[captured]]);
  ...
  // Update hash key
  k.xor_in(Zobrist::psq[pc][from] ^ Zobrist::psq[pc][to]);
  ...
  if (type_of(pc) == PAWN)
  {
      ...
      else if (type_of(m) == PROMOTION)
      {
          ...
          // Update hash keys
          k.xor_in(Zobrist::psq[pc][to] ^ Zobrist::psq[promotion][to]);
          st->pawnKey.xor_in(Zobrist::psq[pc][to]);
          st->materialKey.xor_in(Zobrist::psq[promotion][pieceCount[promotion]-1]
      ...
      st->pawnKey.xor_in(Zobrist::psq[pc][from] ^ Zobrist::psq[pc][to]);
...
Key Position::key_after(Move m) const {
  ...
  if (captured)
      k.xor_in(Zobrist::psq[captured][to]);
